...
const Header = () => (
  <header className="bg-white p-4 flex justify-between items-center shadow-md sticky top-0 z-10">
    <h1 className="text-2xl font-bold text-blue-600">Disaster Management Dashboard</h1>
                  ...
                  {projects.map((project) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="mt-4 w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition-colors duration-300 transform hover:scale-105"
                      >
                        View Project
                      </button>
                    </div>
