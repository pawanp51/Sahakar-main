  ...
  return (
    <div className="min-h-screen bg-white-100">
      ...
      <div className="max-w-7xl mx-auto">
                ...
                className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 w-full md:w-auto m-4"
              >
                Update Info
              </button>
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
              <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
                <h3 className="text-lg font-semibold mb-4">Update Project Info</h3>
                <div className="h-[600px] overflow-y-auto p-4 border border-gray-300 rounded-lg">
...
<form>
  ...
  <div className="mb-4">
    ...
    <input
      type="text"
      className="w-1/3 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 m-2"
  ...
  {/* Parks & Recreation */}
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Parks & Recreation</h3>
    <div className="mb-4">
  ...
  {/* Public Works */}
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Public Works</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Environmental Protection</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  {/* Budget Management */}
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Budget Management</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  <div className="mb-4">
    <label className="block text-gray-700 font-medium mb-2">Overall Progress</label>
    <input
      type="text"
      className="w-1/3 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 m-2"
    ...
    {/* Paroject Initiation */}
    <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Project Initiation</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  {/* Design Phase */}
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Design Phase</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  {/* Construction Start */}
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Construction Start</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
  ...
  {/* Env Assessment */}
  <div className="mb-6">
    <h3 className="text-lg font-bold text-gray-800 mb-2">Environmental Impact Assessment</h3>
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">Status</label>
      <select
        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
